...
from game.constants import WIDTH_CARD_FOR_UI, ZONE_FOR_CARDS, MAX_ZONE_FOR_CARDS, WIDTH
...
class RenderCard:
    ...
    def draw_pl_cards(self):
        ...
        for i, card in enumerate(self.p.hand):
    ...
    def draw_text(self, size, msg, color, pos):
